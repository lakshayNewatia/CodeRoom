...
export const BASE_SERVER_URL = IS_DEV_ENV
  ? "http://localhost:3001"
  : "https://coderoom-km78.onrender.com";
...
export const PISTON_API_URL =
  process.env.NEXT_PUBLIC_PISTON_URL || "http://localhost:2000/api/v2/execute";

export const NAME_MAX_LENGTH = 64;

export const SITE_NAME = "CodeRoom - Code Collaboration Platform";
export const SITE_DESCRIPTION =
  "Your collaborative coding space, reimagined. Code together now on CodeRoom, no sign-up required.";
...
export const LATENCY_TEST_DESCRIPTION =
  "Test your latency to the CodeRoom server.";
